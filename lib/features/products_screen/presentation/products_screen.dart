...
margin: EdgeInsets.all(0),
                child: Container(
                  decoration: BoxDecoration(
                     border: Border(left: BorderSide(color: ColorManager.myGrayLite))
                  ),
                  width: 250,
                  child: Column(children: [
                    ...
                    SubCategoryItem(title: "الكل", onPressed: () {
                      cubit.getProducts();
                    }),
                    state is RetriveCategoriesLoading ||  CategoriesCubit.categoriesList == null
              ...
              Expanded(
                child: Container(
                  child: state is GetProductsLoading || state is RetriveCategoriesLoading
                      ? Center(child: CircularProgressIndicator())
                      ...
                      return ProductItem(
                        product: Product(
                            price: CategoriesCubit
                                .productsListModel?.products![index].price,
                            id: CategoriesCubit
                                .productsListModel?.products![index].id,
                            name: CategoriesCubit
                                .productsListModel?.products![index].name,
