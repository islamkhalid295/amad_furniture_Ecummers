              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child: Column(
                      // children: CartCubit.cartModel?.cart!.products!.map((e) => CartProductItem(product: e, amountController: TextEditingController(text: e.amount.toString()),)).toList() ?? [],
                ...
                Column(
                  children: [
                        ...
                        decoration: ShapeDecoration(
                          shape: RoundedRectangleBorder(
                            side: BorderSide(
                              ...
                              strokeAlign: BorderSide.strokeAlignCenter,
                              color:
                                  Colors.black.withOpacity(0.3199999928474426),
                            ),
                          ),
                        ),
                      ),
                          ...
                          Expanded(
                            child: Center(
                              child: Container(
                                ...
                                child: state is GetCartLoading || CartCubit.cities == null ? Center(child: CircularProgressIndicator()) : DropdownMenu<City>(
                                  // controller: iconController,
                                  requestFocusOnTap: true,
                                  width: 450 *MediaQuery.of(context).size.width/1440,
                                  ...
                                  onSelected: (City? icon) {
                                    // setState(() {
                                    //   selectedIcon = icon;
                                    // });
                                  },
                                  dropdownMenuEntries:
                                  CartCubit.cities == null ? [] : CartCubit.cities!.map<DropdownMenuEntry<City>>(
                                        (City city) {
                                      return DropdownMenuEntry<City>(
                                        value: city,
                                        label: "${city.name}  ج.م  - ${city.deliveryPrice} ",
                                      );
                                    },
                                  ).toList(),
                                ),
                            ...
                            child: Column(
                              children: [
                                ...
                                Directionality(
                                  ...
                                  child: DefaultSelectableText(
                                    CartCubit.cartModel?.cart?.totalPrice?.toStringAsFixed(2)?? "",
                                    style: const TextStyle(
                                      color: Color(0xFF242424),
                                      fontSize: 16,
                                      fontFamily: 'Almarai',
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    DefaultMaterialButton(onPressed: (){}, text: "قدم",minWidth: 120*MediaQuery.of(context).size.width/1440,borderRadius: 0,)
                                  ],
                                ),
                                SizedBox(height: 12,),
                                Row(
                    ...
                    Row(
                      ...
                      children: [
                        DefaultMaterialButton(onPressed: (){}, text: 'اتمام الطلب',minWidth: 360*MediaQuery.of(context).size.width/1440,height: 60,borderRadius: 18),
                        SizedBox(width: 30,),
                        DefaultMaterialButton(onPressed: (){}, text: 'الغاء الطلب',minWidth: 360*MediaQuery.of(context).size.width/1440,height: 60,borderRadius: 18,color: ColorManager.myWhite,textColor: ColorManager.myBlack,borderColor: ColorManager.myBlack),
